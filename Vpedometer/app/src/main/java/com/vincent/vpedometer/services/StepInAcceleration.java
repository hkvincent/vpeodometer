 ...
 * the first mode of step mode class using acceleration to count user step
 */
...
public class StepInAcceleration extends StepMode {
    ...
    private void addBasePedoListener() {
        ...
        if (isAvailable) {
            ...
            Log.v(TAG, "Acceleration sensor can not be used");
        }
    }
    ...
    /**
     * return the step to main activity
     */
    private void preStep() {
        if (CountTimeState == 0) {
            ...
            TEMP_STEP++;
            Log.v(TAG, "step counting TEMP_STEP:" + TEMP_STEP);
        } else if (CountTimeState == 2) {
            CURRENT_STEP++;
            if (stepCallBack != null) {
                stepCallBack.Step(CURRENT_STEP);
            }
        }
    }
